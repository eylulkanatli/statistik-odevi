...
plt.title('1.Tip vs 2.Tip Boru Verileri')
plt.ylabel('Veri Değerleri')

ax.tick_params(axis='y', labelsize=8)
ax.tick_params(axis='x', labelsize=8)

leaf1 = ax.stem(tip1, linefmt='grey', markerfmt='.', use_line_collection=True, label='1.Tip')
plt.setp(leaf1, 'linewidth', 1.0, 'color', 'green')

leaf2 = ax.stem(tip2, linefmt='grey', markerfmt='.', use_line_collection=True, label='2.Tip')
plt.setp(leaf2, 'linewidth', 1.0, 'color', 'orange')
